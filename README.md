# Suno Artifact Cleaner EG

English version of Suno Artifact Cleaner.
...
Audio files selected by the user are processed in the browser. The application code does not upload selected audio to a server.
